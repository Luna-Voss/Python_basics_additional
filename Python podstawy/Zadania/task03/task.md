Napisz program, który na podstawie zmiennej: przychód - `income (float)`, obliczał będzie kwotę należnego podatku dochodowego od osób fizycznych i wypisywał ją w konsoli.
